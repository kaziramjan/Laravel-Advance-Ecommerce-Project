          ...
          <form method="post" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data">
            ...
            <div class="col-12">  
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <img id="showImage" style="height: 100px; width: 100px;" class="rounded-circle" src="{{ (!empty($editData->profile_photo_path))? url('upload/admin_images/'.$editData->profile_photo_path):url('upload/no-image.jpg') }}" alt="User Avatar">
                  </div>
